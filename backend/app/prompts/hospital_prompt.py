def build_hospital_recommendation_prompt(location: str, doctor_type: str) -> str:
    return f"""
You are a reliable medical assistant. Provide a list of the top recommended hospitals and doctors for a {doctor_type} in {location}. 
...
Generate the recommendations now for {doctor_type} in {location}:
"""
